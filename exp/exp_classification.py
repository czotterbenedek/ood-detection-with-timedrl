...
from utils.visual import show_table, show_plot, show_simple_history_plot
...
class Exp_Classification(Exp_Basic):
    ...
    def _get_data(self):
        ...
        class_counts = [v["Train"] for k, v in class_distributions.items() if v["Train"] > 0]  # type: ignore
    ...
    def train(self, use_tqdm=False):
        ...
        # self.args.patience
        model_early_stopping = EarlyStopping(patience=5, verbose=True)
        ...
        for pretrain_epoch in range(self.args.pretrain_epochs):
            ...
            show_simple_history_plot(linear_eval_history, "linear_eval.png")
            show_simple_history_plot(pretrain_history, "pretrain.png")
